 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Tue Jan 27 21:06:14 2026
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                exercise6
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port u0 of S-Function exercise6");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port y0 of S-Function exercise6");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port y1 of S-Function exercise6");
      return;
    }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  const real_T *R = (const real_T *) mxGetDoubles(PARAM_DEF2(S));
  const real_T *J = (const real_T *) mxGetDoubles(PARAM_DEF3(S));
  const real_T *D = (const real_T *) mxGetDoubles(PARAM_DEF4(S));
  exercise6_Outputs_wrapper(u0, y0, y1, xC, L, p_width0, cm, p_width1, R,
    p_width2, J, p_width3, D, p_width4);
}
...
static void mdlDerivatives(SimStruct *S)
{
  ...
  const real_T *J = (const real_T *) mxGetDoubles(PARAM_DEF3(S));
  const real_T *D = (const real_T *) mxGetDoubles(PARAM_DEF4(S));
  exercise6_Derivatives_wrapper(u0, y0, y1, dx, xC, L, p_width0, cm, p_width1, R,
    p_width2, J, p_width3, D, p_width4);
}
